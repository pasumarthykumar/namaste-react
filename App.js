...
const Header =()=>{
    ...
    <div className='header'>
        <div className='logo-container'>
            <img className='logo' alt="not rendered" src="https://www.logodesign.net/logo/smoking-burger-with-lettuce-3624ld.png"></img>
        </div>
    ...
    const {
      ...
      return(
        <div className='res-card' style={{backgroundColor: "#f0f0f0" }}>
            <img className='res-logo' alt='res-logo' src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/" +
                    cloudinaryImageId}>
            </img>
            <h3>{name}</h3>
            <h4>{cuisines.join(", ")}</h4>
